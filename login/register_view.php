...
<head>
    ...
    <title>BPPMDDTT Banjarmasin</title>
    <link rel="shortcut icon" type="image/png" href="../images/logo2023.png" />
        ...
        <div class="position-relative overflow-hidden radial-gradient min-vh-100 d-flex align-items-center justify-content-center">
            <div class="d-flex align-items-center justify-content-center w-100">
                <div class="row justify-content-center w-100">
                    <div class="col-md-8 col-lg-9 col-xxl-3">
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="./index.php" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="../images/logo2023.png" width="180" alt="">
                                </a>
                                <p class="text-center">Daftar Akun Terlebih Dahulu</p>
