...
<html>
<head>
    <title>Cetak Laporan Data Instruktur</title>
    <style type="text/css">
        body{
            font-family: Arial;
        }
...
<hr>
<h3 style="text-align: center;">Laporan Data Instruktur</h3>
...
<table width="100%" border="1" cellspacing="0" cellpadding="4">
    ...
    <?php
    $sqlInstruktur = mysqli_query($konek, "SELECT * FROM Instruktur ORDER BY id ASC");
    $no=1;
    while($d=mysqli_fetch_array($sqlInstruktur)){
        echo "<tr>
           <td align='center'>$no</td>
           <td>$d[nama_instruktur]</td>
