...
<hr>
<h3 style="text-align: center;">Laporan Data Pendaftaran</h3>
...
<table width="100%" border="1" cellspacing="0" cellpadding="4">
    ...
    <?php
    $sqlpendaftaran = mysqli_query($konek, "SELECT * FROM pendaftaran ORDER BY id ASC");
    $no=1;
    while($d=mysqli_fetch_array($sqlpendaftaran)){
        echo "<tr>
           <td align='center'>$no</td>
           <td align='center'>$d[tanggal_pendaftaran]</td>
           <td align='center'>$d[status_pendaftaran]</td>
           <td align='center'>$d[no_peserta]</td>
        </tr>";
        $no++;
    }
    ?>
